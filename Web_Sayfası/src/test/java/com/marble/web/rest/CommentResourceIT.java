...
import com.marble.repository.CommentRepository;
...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().userName(DEFAULT_USER_NAME).description(DEFAULT_DESCRIPTION);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().userName(UPDATED_USER_NAME).description(UPDATED_DESCRIPTION);
        return comment;
    }
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.userName(UPDATED_USER_NAME).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.userName(UPDATED_USER_NAME);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.userName(UPDATED_USER_NAME).description(UPDATED_DESCRIPTION);
