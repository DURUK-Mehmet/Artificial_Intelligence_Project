...
import com.marble.repository.BlogRepository;
...
class BlogResourceIT {
    ...
    public static Blog createEntity(EntityManager em) {
        Blog blog = new Blog().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).date(DEFAULT_DATE);
        return blog;
    }
    ...
    public static Blog createUpdatedEntity(EntityManager em) {
        Blog blog = new Blog().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).date(UPDATED_DATE);
        return blog;
    }
    ...
    void putNewBlog() throws Exception {
        ...
        updatedBlog.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).date(UPDATED_DATE);
    ...
    void fullUpdateBlogWithPatch() throws Exception {
        ...
        partialUpdatedBlog.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).date(UPDATED_DATE);
